...
A<-seq(3,60,by=3)
A<20 #каждый элемент вектора A сравнивается с 20 (меньший вектор повторяется необходимое число раз), и если больше, то записывает вместо этого элемента FALSE,
...
!A<15
!(A<15) #можно в скобках, но они избыточны, старайтесь избегать
...
#3. создать логический вектор RE, элемент которого равен TRUE, если элемент последовательности чисел от 10 до 300, делящихся на
